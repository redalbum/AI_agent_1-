...
![Скриншот: форма агента](../assets/screenshot_agent_ui.png)

### Скриншот: RAG/поиск по метаданным

<!-- TODO: вставить скриншот экрана, где видно RAG/поиск по метаданным и выбранный контекст -->
![Скриншот: RAG/поиск по метаданным](../assets/screenshot_rag_context.png)
...
[Видео (mp4): топ контрагентов по приходным накладным](../assets/demo_top_contractors_incoming_invoices.mp4)
