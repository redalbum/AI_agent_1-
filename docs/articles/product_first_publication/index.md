...
### Картинка подсистемы (да, я нарисовал в Paint — как вам?)

![Подсистема ИИ‑Агент (Paint edition)](./media/agent_subsystem_paint.png)
...
<!-- TODO: вставить скриншот формы агента -->
![Скриншот: форма агента](./media/screenshot_agent_ui.png)

### Скриншот: RAG/поиск по метаданным

<!-- TODO: вставить скриншот экрана, где видно RAG/поиск по метаданным и выбранный контекст -->
![Скриншот: RAG/поиск по метаданным](./media/screenshot_rag_context.png)

### Видеодемонстрация: простой запрос

Запрос для демо: **«Выведи топ контрагентов по суммам приходных накладных»**.

<!-- TODO: добавить ссылку на видео -->
[Видео (mp4): топ контрагентов по приходным накладным](./media/demo_top_contractors_incoming_invoices.mp4)

Короткие требования к ролику (чтобы он был “смотрибельным”):
- 20–40 секунд, без лишних окон и переключений
- видно: ввод запроса → выполнение → табличный результат → короткое резюме
- если есть чувствительные данные — замажьте/обезличьте
